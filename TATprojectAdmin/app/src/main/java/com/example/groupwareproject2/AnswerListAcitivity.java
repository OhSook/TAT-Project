...
public class AnswerListAcitivity extends AppCompatActivity {
    // 본인 DB계정으로 변경
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answer_list_acitivity);
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery("SELECT TITLE, WRITE_DATE, USER_WRITER, ANSWER_CONTENT FROM QA WHERE ANSWER_CONTENT IS NULL");
