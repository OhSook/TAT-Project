...
public class RecyclerViewAdapterCom extends RecyclerView.Adapter<RecyclerViewAdapterCom.ViewHolder> {
    //
    ...
    // 생성자
    public RecyclerViewAdapterCom(ArrayList<SingleItem> list, Context context) {
        items = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.items_for_comrecyclerview, parent, false);
        RecyclerViewAdapterCom.ViewHolder vh = new RecyclerViewAdapterCom.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterCom.ViewHolder holder, int position) {
        ...
        holder.textTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ComAnsDetailActivity.class);
                intent.putExtra("title", title);
